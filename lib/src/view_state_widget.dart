...
class KIViewStateWidget<T> extends StatelessWidget {
  ...
  /// 当 [KIViewState] 的 [state] 属性为 [KIViewStateType.finished] 时，会构建本方法返回的 [Widget]
  /// 当 [KIViewState] 的 [state] 属性不为 [KIViewStateType.finished]，但是没有提供相应状态的 [Widget]，也会构建本方法返回的 [Widget]
  final Widget Function(BuildContext context, KIViewState<T> state) builder;

  /// 当 [KIViewState] 的 [state] 属性为 [KIViewStateType.initial] 时，会构建本方法返回的 [Widget]
  final Widget Function(BuildContext context, KIViewState<T> state)? initial;

  /// 当 [KIViewState] 的 [state] 属性为 [KIViewStateType.loading] 时，会构建本方法返回的 [Widget]
  final Widget Function(BuildContext context, KIViewState<T> state)? loading;

  /// 当 [KIViewState] 的 [error] 属性不为 [null] 并且 [state] 属性为 [KIViewStateType.finished] 时，会优先构建本方法返回的 [Widget]
